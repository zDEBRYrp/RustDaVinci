...
class Settings(QDialog):
    ...
    def connectAll(self):
        ...
        if hasattr(self.ui, "brush_coords_PushButton"):
            self.ui.brush_coords_PushButton.clicked.connect(self.brush_coords_clicked)
        ...
        self.ui.monitor_ComboBox.currentIndexChanged.connect(self.enableApply)
    ...
    def loadSettings(self):
        ...
        self.ui.monitor_ComboBox.clear()
    ...
    def saveSettings(self):
        ...
        self.settings.setValue("monitor_index", self.ui.monitor_ComboBox.currentIndex())
    ...
    def brush_coords_clicked(self):
        """ Opens a dialog to configure external brush / HEX coordinates and values """
